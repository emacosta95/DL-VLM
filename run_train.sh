...
nohup python train.py --time_interval=$time_interval  --model_type="LSTM" --input_channels=1 --output_channels=1 --input_size 1 --output_size 1 --kernel_size 5 1 --padding 0 --pooling=0    --data_path 'data/dataset_h_eff/new_analysis_xxzx_model/pbc_training_dataset_fixed_initial_state_time_10_nsteps_100_ndata_5000.npz'  --model_name=new_analysis_lstm_field2field/LSTM_field2field_xxzx_nonlinear_auxiliary_field_fixed_initial_state_time_steps_30_tf_3_241219_dataset_5k --hidden_channels 500 500 500 500   --keys h h_eff    --epochs=2000      > output_model_field2field_lstm_3.txt &
