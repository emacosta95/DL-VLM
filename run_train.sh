...
nohup python train.py --time_interval=$time_interval  --model_type="LSTM" --input_channels=1 --output_channels=1 --input_size 1 --output_size 1 --kernel_size 5 1 --padding 0 --pooling=0    --data_path 'data/dataset_h_eff/new_analysis_xxzx_model/dataset_2025-03-03_16-43.npz'  --model_name=LSTM_f2f_fixed_initial_state_tf_10_nsteps_500_250629_dataset_10k --hidden_channels 64 64 --keys h h_eff    --epochs=2000      > output_model_f2f_lstm_1.txt &
