...
nohup python train.py --time_interval=$time_interval --input_size=8 --model_type="TDDFTCNN" --input_channels=1 --kernel_size 3 9 --data_path 'data/dataset_h_eff/train_dataset_quench_driving_ndata_10000_steps_500.npz' --pooling=1 --model_name=kohm_sham/cnn_field2field/model_field2field_t_interval_500_240207_quench_dataset --hidden_channels 80 80 80 80 80  --keys h potential     --epochs=5000      > output_model_field2field_cnntddft.txt &
