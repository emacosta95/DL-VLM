...
nohup python train.py --time_interval=$time_interval  --model_type="LSTM" --input_channels=1 --output_channels=1 --input_size 1 --output_size 1 --kernel_size 5 1 --padding 0 --pooling=0    --data_path 'data/dataset_h_eff/new_analysis_xxzx_model/dataset_2025-06-29_18-55.npz'  --model_name=dataset_2025-06-29_18-55_LSTM_f2f_fixed_initial_state_tf_10_nsteps_1000_250630_dataset_10k --hidden_channels 200 --keys h h_eff    --epochs=2000      > output_model_f2f_lstm_4.txt &
