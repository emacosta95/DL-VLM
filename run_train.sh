...
nohup python train.py --time_interval=$time_interval  --model_type="LSTM" --input_channels=1 --output_channels=1 --input_size 8 --kernel_size 0 --padding 0 --pooling=0    --data_path 'data/dataset_h_eff/periodic/xxzx_model/dataset_periodic_random_rate_03-1_random_amplitude_01-08_fixed_initial_state_nbatch_1_batchsize_20000_steps_400_tf_40.0_l_8_240601.npz'  --model_name=kohm_sham/cnn_field2field/LSTM_field2field_xxzx_time_steps_200_tf_40_240603_dataset_20k --hidden_channels 200 200 200 200 200 200 200  --keys h h_eff    --epochs=2000      > output_model_field2field_lstm_1.txt &
