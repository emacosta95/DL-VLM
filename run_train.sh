...
nohup python train.py --time_interval=$time_interval --input_size=8 --model_type="DenseAutoEncoder" --input_channels=2 --output_channels=2 --input_size  101 8  --kernel_size 5 --padding 2     --data_path 'data/dataset_h_eff/train_dataset_fourier_format_half_spectrum_ndata_60000.npz' --pooling=1 --model_name=kohm_sham/cnn_field2field/DenseAutoEncoder_fourier_field2field_time_steps_200_tf_20_240327_dataset_60k --hidden_channels 1600 1600 1600 1600 --keys h potential     --epochs=5000      > output_model_field2field_unet_1.txt &
