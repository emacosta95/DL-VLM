...
nohup python train.py --time_interval=$time_interval --input_size=8 --model_type="TDDFTCNN" --input_channels=1 --output_channels=1 --input_size=8 --kernel_size 5 15    --data_path 'data/dataset_h_eff/train_dataset_periodic_driving_ndata_100000_steps_100_240226.npz' --pooling=1 --model_name=kohm_sham/cnn_field2field/TDDFTCNN_field2field_periodic_time_interval_500_240227_periodic_dataset --hidden_channels 80 80 80 80 80 80 --keys h potential     --epochs=1000      > output_model_field2field_cnntddft.txt &
